...
class SyncService (
    ...
    fun getLastDeltaSync(orgId: String, component: String, adapterId : String) = getByComponent(orgId, component).filter { it.syncType.isDelta() && it.adapterId == adapterId }

    fun getLastFullSync(orgId: String, component: String, adapterId : String) = getByComponent(orgId, component).filter { it.syncType.isFull() && it.adapterId == adapterId }
